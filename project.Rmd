...
### Categorize data
By using one hot encoding method,we replace the levels of each categorical variables with meaningful names to have a good interpretation of the model.For example:
...
boxplot(x = list(sqrt(mspe1), sqrt(mspe2)), names = expression(M[BWD], M[STEP]), cex = .7,
