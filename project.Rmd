...
```
The above table indicates which entry when max leverage occurs and which entry when max influential point occurs. We have the following outliers detected by the LeverageInfluence function.
